...
import com.wisrc.rule.exception.RuleCheckException;
...
@Service
@Slf4j
public class DroolsServicesImpl  implements DroolsServices{
    ...
    private Collection<KiePackage> loadDynamicRules() {
        ...
        for (KnowledgeBuilderError error : errors) {
            ...
            throw new RuleCheckException("Rule Check Exception");
        }
